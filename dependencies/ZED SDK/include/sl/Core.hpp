...
namespace sl {
    ...
    */
    static inline timeStamp getCurrentTimeStamp() {
        ...
        timeStamp NSEC_PER_SEC = 1000000000ULL;
        ...
        current_ts = ((timeStamp) start.QuadPart * NSEC_PER_SEC / (timeStamp) freq.QuadPart);
#else
        ...
        if (clock_gettime(CLOCK_MONOTONIC, &now) != 0) {
            ...
            current_ts = ((uint64_t) now.tv_sec * NSEC_PER_SEC + (uint64_t) now.tv_nsec);
#endif
        return current_ts;
    }
    ...
    */
    ...
    /**
    \class Rotation
    \brief Designed to contain rotation data of the positional tracking. It inherits from the generic sl::Matrix3f
    */
    class SL_CORE_EXPORT Rotation: public Matrix3f {
    public:
        /**
        ...
        */
        ...
        \param euler_angles : The Euler angles, as a sl::float3 (x=roll, y=pitch, z=yaw)
        \param radian : Define if the angle in is radian or degree
        */
    ...
    */
    class SL_CORE_EXPORT Orientation: public sl::float4 {
    public:
        /**
        ...
        */
        ...
        /**
        \brief Alias to setRotationMatrix()
        \deprecated
        */
    ...
    It contains the orientation as well. It can be used to create any type of Matrix4x4 or sl::Matrix4f that must be specifically used for handling a rotation and position information (OpenGL, Tracking...)
    It inherits from the generic sl::Matrix4f
    */
    class SL_CORE_EXPORT Transform: public Matrix4f {
    public:
        /**
